...
import Latihan.FileChooserDemo;
import Latihan.Aksi;
...
public class DataMahasiswa{
	...
	public static void main(String[] arg){
		...
		Oke.addActionListener(new Aksi());
		Oke.setActionCommand("1");
		
		JButton Batal = new JButton("BATAL");
		Batal.setFont(new Font("Comic Sans MS", Font.BOLD, 12));
		Batal.addActionListener(new Aksi());
		Batal.setActionCommand("2");
		...
		inframe.setTitle("internal frame Data Mahasiswa");
		...
		bingkai.setContentPane(desktop);
